...
- [CreateBillboardOptions](interfaces/CreateBillboardOptions.md)
- [CreateLabelOptions](interfaces/CreateLabelOptions.md)
- [CreatePinImageOptions](interfaces/CreatePinImageOptions.md)
...
- [createBillboardEntity](functions/createBillboardEntity.md)
- [createLabelEntity](functions/createLabelEntity.md)
